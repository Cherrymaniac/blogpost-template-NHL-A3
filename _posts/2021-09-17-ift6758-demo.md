...
If you are interested in more general template features or syntax, you can visit the [Introducing Lanyon]({% post_url 2020-04-03-introducing-lanyon %})or  [Milestone 1]({% post_url 2024-10-4-milestone-1 %}) or the [Example Content]({% post_url 2020-04-02-example-content %}) posts.
